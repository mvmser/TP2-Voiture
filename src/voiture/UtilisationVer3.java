...
public class UtilisationVer3{
	...
	public static void testMappings2() {
		...
		garage.resetPartielAll();
		System.out.println("\n remise ï¿½ 0 des compteurs partiels de tous les vï¿½hiculess!");
		System.out.println(garage);

		garage.faireLePleinAll();
		System.out.println("\n faire le plein de tous les vï¿½hicules s'il reste moins de 10 litres !");
		System.out.println(garage);
	}
	 ...
	 * l'on rï¿½fï¿½rence ensuite par un garage CompteurComparable
	 * en effet, les vï¿½hicules ayant tous un compteur ï¿½ 0 lors de leur instanciation ne seraient pas ajoutï¿½s 
	 * ï¿½ un garage CompteurComparable, car un Set est sans doublon par rapport au critï¿½re de comparaison
	*/
